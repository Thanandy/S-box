...
```
PORT=你的端口 CFIP=www.visa.com.tw CFPORT=443 bash <(curl -Ls https://raw.githubusercontent.com/Thanandy/S-box/main/sing-box.sh)
```
...
```
bash <(curl -Ls https://raw.githubusercontent.com/Thanandy/S-box/main/sb_serv00.sh)
```
...
```
VMESS_PORT=tcp端口 HY2_PORT=udp端口 TUIC_PORT=udp端口 bash <(curl -Ls https://raw.githubusercontent.com/Thanandy/S-box/main/sb_00.sh)
```
...
或
```
PORT=UDP端口 bash <(curl -Ls https://github.com/Thanandy/S-box/releases/download/00/2.sh)
```
...
或
```
PORT=UDP端口 bash <(curl -Ls https://github.com/Thanandy/S-box/releases/download/00/tu.sh)
```
